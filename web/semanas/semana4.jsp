        ...
        <div class="container">
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-sort-amount-up me-2"></i>MayorDeTres.txt
                </h3>
                ...
                <div>
                    <a href="../semana4/codigo/MayorDeTres.txt" class="btn-download" download>
...
public class MayorDeTres {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-graduation-cap me-2"></i>ClasificacionNotas.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana4/codigo/ClasificacionNotas.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class ClasificacionNotas {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-calculator me-2"></i>CalculadoraSwitch.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana4/codigo/CalculadoraSwitch.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class CalculadoraSwitch {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-calendar-day me-2"></i>DiaSemanaSwitch.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana4/codigo/DiaSemanaSwitch.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class DiaSemanaSwitch {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-tags me-2"></i>DescuentoCategoria.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana4/codigo/DescuentoCategoria.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class DescuentoCategoria {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-balance-scale me-2"></i>ClasificadorNumeros.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana4/codigo/ClasificadorNumeros.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
