        ...
        <div class="container">
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-wave-square me-2"></i>SerieFibonacci.txt
                </h3>
                ...
                <div>
                    <a href="../semana6/codigo/SerieFibonacci.txt" class="btn-download" download>
...
public class SerieFibonacci {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-superscript me-2"></i>SeriePotencias.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana6/codigo/SeriePotencias.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class SeriePotencias {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-exclamation me-2"></i>SerieFactorial.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana6/codigo/SerieFactorial.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class SerieFactorial {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-calculator me-2"></i>CalculadoraAvanzada.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana6/codigo/CalculadoraAvanzada.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class CalculadoraAvanzada {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-chart-line me-2"></i>SerieGeometrica.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana6/codigo/SerieGeometrica.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class SerieGeometrica {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-list-ol me-2"></i>MenuSeries.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana6/codigo/MenuSeries.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
