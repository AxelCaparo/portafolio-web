        ...
        <div class="container">
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-money-bill-wave me-2"></i>SueldoEmpleado.txt
                </h3>
                ...
                <div>
                    <a href="../semana2/codigo/SueldoEmpleado.txt" class="btn-download" download>
...
public class SueldoEmpleado {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-tshirt me-2"></i>CompraCamisas.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana2/codigo/CompraCamisas.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class CompraCamisas {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-bus me-2"></i>DescuentoPasajes.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana2/codigo/DescuentoPasajes.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class DescuentoPasajes {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-graduation-cap me-2"></i>PromedioFinal.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana2/codigo/PromedioFinal.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class PromedioFinal {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-chart-line me-2"></i>InversionFeria.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana2/codigo/InversionFeria.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
