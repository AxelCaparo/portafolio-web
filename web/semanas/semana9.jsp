        ...
        <div class="container">
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-plug me-2"></i>ConexionDB.txt
                </h3>
                ...
                <div>
                    <a href="../semana8/codigo/ConexionDB.txt" class="btn-download" download>
...
public class ConexionDB {
    ...
    public static void main(String[] args) {
        try {
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-plus-circle me-2"></i>InsertarDatos.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana8/codigo/InsertarDatos.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class InsertarDatos {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-search me-2"></i>ConsultarDatos.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana8/codigo/ConsultarDatos.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class ConsultarDatos {
    public static void main(String[] args) {
        ...
        try (Connection conn = ConexionDB.getConnection();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-edit me-2"></i>ActualizarDatos.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana8/codigo/ActualizarDatos.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class ActualizarDatos {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-trash-alt me-2"></i>EliminarDatos.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana8/codigo/EliminarDatos.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class EliminarDatos {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-list-alt me-2"></i>MenuCRUD.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana8/codigo/MenuCRUD.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
