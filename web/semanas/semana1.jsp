        ...
        <div class="container">
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-vector-square me-2"></i>Rectangulo.txt
                </h3>
                ...
                <div>
                    <a href="semana1/codigo/Rectangulo.txt" download class="btn-download">
...
public class Rectangulo {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-diamond me-2"></i>Rombo.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="semana1/codigo/Rombo.txt" download class="btn-download">
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class Rombo {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-play me-2"></i>Triangulo.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="semana1/codigo/Triangulo.txt" download class="btn-download">
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class Triangulo {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-circle me-2"></i>Circulo.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="semana1/codigo/Circulo.txt" download class="btn-download">
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class Circulo {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-calculator me-2"></i>OperacionesBasicas.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="semana1/codigo/OperacionesBasicas.txt" download class="btn-download">
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
