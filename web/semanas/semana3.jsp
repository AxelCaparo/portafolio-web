        ...
        <div class="container">
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-calculator me-2"></i>CalculadoraMetodos.txt
                </h3>
                ...
                <div>
                    <a href="../semana3/codigo/CalculadoraMetodos.txt" class="btn-download" download>
...
public class CalculadoraMetodos {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-temperature-high me-2"></i>ConversorTemperatura.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana3/codigo/ConversorTemperatura.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class ConversorTemperatura {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-weight me-2"></i>CalculadoraIMC.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana3/codigo/CalculadoraIMC.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class CalculadoraIMC {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-lock me-2"></i>ValidadorContrasena.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana3/codigo/ValidadorContrasena.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class ValidadorContrasena {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-coins me-2"></i>ConversorMoneda.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana3/codigo/ConversorMoneda.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
...
public class ConversorMoneda {
    ...
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            <div class="programa-card">
                <h3 class="programa-title">
                    <i class="fas fa-hashtag me-2"></i>NumeroPrimo.txt
                </h3>
                <p class="programa-description">
                ...
                <div>
                    <a href="../semana3/codigo/NumeroPrimo.txt" class="btn-download" download>
                        <i class="fas fa-download me-2"></i>Descargar Código
                    </a>
